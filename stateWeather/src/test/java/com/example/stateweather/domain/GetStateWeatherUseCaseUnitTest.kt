package com.example.stateweather.domain
...
class GetStateWeatherUseCaseUnitTest {
    ...
    private val weatherRepository: com.example.stateweather.domain.repository.WeatherRepository = mockk()

    private lateinit var getStateWeatherUseCase: com.example.stateweather.domain.usecase.GetStateWeatherUseCase
    ...
    fun setUp() {
        ...
        getStateWeatherUseCase =
            com.example.stateweather.domain.usecase.GetStateWeatherUseCase(weatherRepository)
    }
    ...
    fun `invoke should return Success when repository returns data`() = runTest {
        val countryCode = "EG"
        val repoStateWeatherDto = com.example.stateweather.data.remote.dto.StateWeatherDto(
            locationInfo = com.example.stateweather.data.remote.dto.LocationInfoDto(
                name = "Cairo",
                country = "Egypt",
                timezoneId = "GMT+2"
            ),
            currentWeather = com.example.stateweather.data.remote.dto.CurrentWeatherDto(
